	...
	return (
		<div id='kho-muc'>
					...
					<div className='grid grid-cols-1 lg:grid-cols-12 lg:space-x-5'>
						<div className='col-span-5 flex justify-start'>
							<div className='flex flex-col items-center gap-6'>
								<Image src='/images/Details/kho-muc-1.jpeg' alt='Khô mực ngon' width={600} height={600} className='object-center rounded-md' />
								<button className='hidden lg:block sm:text-xl text-lg w-full sm:w-auto font-medium rounded-full text-white sm:py-4 sm:px-5 px-4 py-2 bg-pink lg:px-10 mr-6 hover:bg-[#c25947] mt-4 capitalize transition-all hover:shadow-orange'>
						...
						<div className='col-span-7 flex flex-col justify-start'>
							...
							<Fade direction={'up'} delay={600} cascade damping={1e-1} triggerOnce={true}>
								...
								<button className='lg:hidden block sm:text-xl text-lg w-full sm:w-auto font-medium rounded-full text-white sm:py-4 sm:px-5 px-4 py-2 bg-pink lg:px-10 mr-6 hover:bg-[#c25947] mt-4 capitalize transition-all hover:shadow-orange'>
									<a href='tel:0931888357'>Liên hệ đặt mua ngay</a>
								</button>
							</Fade>
						</div>
				...
				<div className='mx-auto max-w-7xl lg:pt-10 pb-24 px-6'>
					<div className='grid grid-cols-1 lg:grid-cols-12 lg:space-x-5'>
						<div className='lg:hidden col-span-6 flex justify-start mt-3'>
							<Image src='/images/Details/kho-ca-com-1.jpg' alt='Khô cá cơm một nắng ngon' width={600} height={600} className='object-center rounded-md' />
						</div>
						<div className='col-span-7 flex flex-col justify-start'>
							<Fade direction={'up'} delay={200} cascade damping={1e-1} triggerOnce={true}>
						...
						<div className='col-span-5 hidden lg:flex justify-start mt-3'>
							<div className='flex flex-col items-center gap-6'>
								<Image src='/images/Details/kho-ca-com-1.jpg' alt='Khô cá cơm một nắng ngon' width={600} height={600} className='object-center rounded-md' />
			...
			<div className='relative' id='cha-ram-tom'>
				<div className='mx-auto max-w-7xl lg:pt-10 pb-24 px-6'>
					<div className='grid grid-cols-1 lg:grid-cols-12 lg:space-x-5'>
						<div className='col-span-5 flex justify-start mt-6 md:mt-0 mb-3'>
							<div className='flex flex-col items-center gap-6'>
								<Image src='/images/Details/cha-ram-tom-3.jpg' alt='Chả ram tôm đất Bình Định ngon' width={600} height={600} className='object-center rounded-md' />
								<button className='hidden lg:block sm:text-xl text-lg w-full sm:w-auto font-medium rounded-full text-white sm:py-4 sm:px-5 px-4 py-2 bg-pink lg:px-10 mr-6 hover:bg-[#c25947] mt-4 capitalize transition-all hover:shadow-orange'>
									<a href='tel:0931888357'>Liên hệ đặt mua ngay</a>
								</button>
							</div>
						...
						<div className='col-span-6 flex flex-col justify-start'>
							...
							<Fade direction={'up'} delay={600} cascade damping={1e-1} triggerOnce={true}>
								...
								<p className='text-grey md:text-lg font-normal text-start mt-2'>
									...
									của thịt heo. Hương vị hấp dẫn, cuốn hút khiến thực khách đặc biệt nghiện, lúc nào cũng mua thêm chả ram tôm đất này về nhà để dành thưởng thức.
								</p>
								<p className='text-grey md:text-lg font-normal mt-1 text-start'>
									<b>Chả ram tôm đất Bình Định</b> không chỉ là một món ăn truyền thống, mà còn là một biểu tượng ẩm thực của Bình Định. Bạn có thể thưởng thức sản phẩm với các
									cách chế biến sau: Chả ram cuốn bánh cuốn thịt, Chả ram ăn với bún, Chả ram cuốn rau xanh thơm ngon, Khai vị chả ram, Chả ram ăn cùng với cơm,...
								</p>
								<button className='lg:hidden block sm:text-xl text-lg w-full sm:w-auto font-medium rounded-full text-white sm:py-4 sm:px-5 px-4 py-2 bg-pink lg:px-10 mr-6 hover:bg-[#c25947] mt-4 capitalize transition-all hover:shadow-orange'>
									<a href='tel:0931888357'>Liên hệ đặt mua ngay</a>
								</button>
			...
			<div className='relative' id='nuoc-mam-nhi'>
				<div className='mx-auto max-w-7xl lg:pt-10 pb-24 px-6'>
					<div className='grid grid-cols-1 lg:grid-cols-12 lg:space-x-5'>
						<div className='lg:hidden col-span-6 flex justify-start mt-3'>
							<Image src='/images/Details/nuoc-mam-1.jfif' alt='Nước mắm nhỉ truyền thống Bình Định ngon' width={636} height={808} className='object-center rounded-md' />
						</div>
						<div className='col-span-7 flex flex-col justify-start'>
							<Fade direction={'up'} delay={200} cascade damping={1e-1} triggerOnce={true}>
